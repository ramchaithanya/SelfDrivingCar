        ...
        if (event == "telemetry") {
          ...
          for(int i = 0;i<sensor_fusion.size(); i++)
          {
              ...
              if( d < ( 2 + 4*lane + 2) && d > (2 + 4*lane - 2))
              {
                ...
                check_car_s += ((double)prevSize*0.02*check_speed);
          ...
          if(prevSize < 2)
          {
              double prevCar_x = car_x - cos(car_yaw);
              double prevCar_y = car_y - sin(car_yaw);
              ptsx.push_back(prevCar_x);
              ptsx.push_back(car_x);
              ptsy.push_back(prevCar_y);
